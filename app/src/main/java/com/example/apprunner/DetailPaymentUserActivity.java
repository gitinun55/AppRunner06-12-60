...
public class DetailPaymentUserActivity extends AppCompatActivity {
    ...
    private void summit_payment(int id_reg_event){
        ...
        call.enqueue(new Callback<ResultQuery>() {
            ...
            public void onResponse(Call<ResultQuery> call, Response<ResultQuery> response) {
                Intent intent = new Intent(DetailPaymentUserActivity.this, Select_user_paymentActivity.class);
    ...
    private void setDetail_payment(){
        ...
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .build();
        OrganizerAPI service = retrofit.create(OrganizerAPI.class);
        Call<ResultQuery> call = service.show_user_payment(id_add);
        call.enqueue(new Callback<ResultQuery>() {
            @Override
            public void onResponse(Call<ResultQuery> call, Response<ResultQuery> response) {
                ...
                Picasso.with(DetailPaymentUserActivity.this).load(resultQuery.getImage_link()).into(edt_Pic);
            }
    ...
    private void getId_reg_event(){
        ...
        call.enqueue(new Callback<ResultQuery>() {
            ...
            public void onResponse(Call<ResultQuery> call, Response<ResultQuery> response) {
                ...
                Toast.makeText(DetailPaymentUserActivity.this,Integer.toString(id_reg_event),Toast.LENGTH_LONG).show();
            }
