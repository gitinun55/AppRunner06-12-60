...
public class UplodePaymentActivity extends AppCompatActivity {
    ...
    String photoStringLink,first_name,last_name,type,date,time,bank;
    int id_user,id_add;
        ...
        btn_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(validate(id_user,id_add,date,time,bank)){
                    uploadImage(id_user,id_add,date,time,bank);
                }
            }
        });
    }
    ...
    private void uploadImage(final int id_user,final int id_add,final String date,final String time,final String bank) {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            downloadUri.addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    upload_payment(id_user,id_add,photoStringLink,date,time,bank);
    ...
    private void upload_payment(final int id_user,int id_add,String photoStringLink,String date,String time,String bank){
        ...
        Call<ResultQuery> call = service.upload_payment(new UploadPaymentDB(id_user,id_add,photoStringLink,date,time,bank));
        call.enqueue(new Callback<ResultQuery>() {
            @Override
            public void onResponse(Call<ResultQuery> call, Response<ResultQuery> response) {
                Intent intent = new Intent(UplodePaymentActivity.this, SelectPaymentUserActivity.class);
